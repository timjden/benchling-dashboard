...
df = run_query("get-leaf-biomass-infl-week.sql")
print(df)

#SHAMELESSLY SMOOSHED TOGETHER FROM STACK OVERFLOW
filename = "C:/Users/timjd/OneDrive - Cape Biologix Technologies (Pty) Ltd/BenchlingReports/Other Data/Leaf Biomass Infiltrated per Week (Kg) " + str(today.strftime("%Y")) + ".xlsx"
